...
- blue block entity tracers, draws a blue tracer to any double chest if the chest is not in a dungeon or single or double chest if the chest is in a dungeon with a broken spawner (potential kit shop dropoff location)
